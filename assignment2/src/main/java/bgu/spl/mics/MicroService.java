...
public abstract class MicroService implements Runnable {
    ...
    private String name;
    private Map<Class<? extends Message>, Callback> callBackByMsgType;
    ...
    public MicroService(String name) {
        this.name = name;
        this.callBackByMsgType = new ConcurrentHashMap<>();
        this.isAlive = true;
    }
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        callBackByMsgType.put(type, callback);
    }
    ...
    public final void run() {
        ...
        while (isAlive) {
            ...
            //execute
            if (message != null) {
                callBackByMsgType.get(message.getClass()).call(message);
            }
        }
    }
}
